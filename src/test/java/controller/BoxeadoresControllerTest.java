...
public class BoxeadoresControllerTest {
    ...
    public void crearBoxeador() throws Exception {
        ...
        Mockito.when(this.boxeadorServiceImp.create(boxeadorDTO)).thenReturn(boxeadorDTO);
    ...
    public void queNosePuedaCrearBoxeador() throws Exception {
        ...
        Mockito.when(this.boxeadorServiceImp.create(boxeadorDTO)).thenThrow(new Exception("El entrenador ha alcanzado el límite de boxeadores (5)."));
